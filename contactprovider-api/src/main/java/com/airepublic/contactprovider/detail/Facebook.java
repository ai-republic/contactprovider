...
/**
 * Implementation of {@link IContactDetail} for facebook contact type.
 * 
 * @author Torsten.Oltmanns@ai-republic.com
 */
@Entity
public class Facebook extends AbstractContactDetail<String> {
	private static final long serialVersionUID = 8810610524797812753L;
	
	/**
	 * Constructor.
	 */
	public Facebook() {
		setType(ContactType.FACEBOOK);
	}
}
